...
<%
    ...
    if(paramSubmit != null){
        ...
        item.setEspecialidade(controller.getEspecialidade(Long.parseLong(request.getParameter("especialidade"))));
        item.setUnidade(controller.getUnidade(Long.parseLong(request.getParameter("unidade"))));
        ...
        try{
            if(status > 0){
                ...
                alertaTipo = "sucesso";
                String url = "profissionais.jsp?alertaMensagem="+alertaMensagem+"&alertaTipo="+alertaTipo;
        ...
        <main>
            ...
            <form method="post">
                <div class="grid">
                    ...
                    <input type="text" name="nome" id="nome" required value="<%= item.getNome() != null ? item.getNome() : "" %>">
                    <label for="registroConselho">Registro</label>
                    <input type="text" name="registroConselho" id="registroConselho" required value="<%= item.getRegistroConselho() != null ? item.getRegistroConselho() : "" %>">
